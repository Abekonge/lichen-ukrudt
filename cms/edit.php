...
if ($_SERVER['REQUEST_METHOD'] === 'PUT') {
	...
	define("RESIZABLE_IMAGE_EXTENSIONS", ["png", "avif", "bmp", "jpg", "jpeg", "webp"]);
...
<head>
	...
	<style>
		* {
		...
		#files li.file:hover,
		#files li.directory summary:hover {
			background: #f0f0f0;
		}
		...
		#files li.file:hover .actions,
		#files li.directory summary:hover .actions {
			visibility: visible;
		}
